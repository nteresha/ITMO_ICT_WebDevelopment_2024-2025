...
class EquipmentOfSportHall(models.Model):
    equipment = models.ForeignKey('Equipment', on_delete=models.CASCADE, null=True, verbose_name='Оборудование')
    sport_hall = models.ForeignKey('SportHall', verbose_name='Спортзал', on_delete=models.CASCADE)
